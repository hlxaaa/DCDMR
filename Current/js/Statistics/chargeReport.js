...
$(document).ready(function () {
    ...
    $('.btn-getExcel').click(function () {
        jQuery.postNL('../StatisticsAjax/GetExcelCount', "", function (data) {
            if (data.Message == "1") {
                TestExcel();
            } else {
                layer.msg('没有数据可以导出');
...
function changePage(index) {
    ...
    //console.log(data);
    jQuery.postNL('../StatisticsAjax/GetChargeReport', data, function (data) {
        var index = 1;
        var pages = 1;
        ...
        var h = '<table class="table"><tr><th class=" " data-sort="dt">时间</th><th class="" data-sort="sumVolume">充值气量</th></tr>';
        //<th class=" " data-sort="sumMoney">充值金额</th>
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var sumVolume = item.sumVolume == null ? "" : item.sumVolume;
            ...
            //<td class="center tds td-sumMoney" title="' + sumMoney + '">' + sumMoney + '</td>
        }
        h += ' </table>';
...
function changeLine() {
    ...
    jQuery.postNL('../statisticsAjax/GetChargeLine', data, function (data) {
        var days = data.level;
        var list = data.ListData;
        var datas1 = new Array();
        for (var i = 0; i < list.length; i++) {
            datas1.push(parseFloat(list[i].sumVolume));
        }
...
//打印报表
function TestExcel() {
    location.href = '/StatisticsAjax/GetChargeExcel';
}
...
function changePieType() {
    ...
    jQuery.postNL('../statisticsAjax/GetChargePieByType', data, function (data) {
        //var days = data.level
        var list = data.ListData;
        //console.log(list);
        //var datas1 = new Array();
...
function changePieTime() {
    ...
    jQuery.postNL('../statisticsAjax/GetChargePieByTime', data, function (data) {
        //var days = data.level
        var list = data.ListData;
        //console.log(list);
        //var datas1 = new Array();
